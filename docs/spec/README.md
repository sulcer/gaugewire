...
|---|---|---|---|
| [`gaugewire`](gaugewire/README.md) | Draft | Partial | The product: capture Claude Code quota from the status line, normalize, persist, publish to sinks. Databox is the first sink. All v1 commands built; the acceptance test on a real machine is the remaining proof. |
