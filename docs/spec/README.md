...
|---|---|---|---|
| [`gaugewire`](gaugewire/README.md) | Draft | Planned | The product: capture Claude Code quota from the status line, normalize, persist, publish to sinks. Databox is the first sink. |
| [`repo-scaffold`](repo-scaffold/README.md) | Draft | Planned | How the repository is built, gated, released and made legible to humans and agents. |
