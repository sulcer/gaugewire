...
|---|---|---|---|
| [`gaugewire`](gaugewire/README.md) | Draft | Partial | The product: capture Claude Code quota from the status line, normalize, persist, publish to sinks. Databox is the first sink. Install, uninstall and doctor built; the Databox sink is next. |
