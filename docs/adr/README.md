...
|---|---|---|---|---|
| 2026-09-20 | [only-a-recent-payload-may-move-a-window](2026-09-20-only-a-recent-payload-may-move-a-window.md) | A reading whose reset has passed is refused; only a payload whose five-hour window is still running may move a window to a different reset; within one window the highest usage wins | accepted | Amends claude-statusline-is-the-only-quota-source (the staleness guard) |
